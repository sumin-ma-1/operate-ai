...
/** Frosted glass surface used by home saved workflows and Open Space gallery. */
export const glassCardClassName =
  "group flex h-full flex-col gap-3 !rounded-[1.75rem] !border-white/20 !bg-white/[0.08] !p-5 !shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-xl transition duration-300 hover:!border-white/35 hover:!bg-white/[0.12] hover:!shadow-[0_12px_40px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.22)]";
